# Collectord Helm Charts for Monitoring Kubernetes in Elasticsearch
...
The liveness and readiness probes keep working unchanged: they reach the server on `127.0.0.1`,
which `0.0.0.0` still covers.
